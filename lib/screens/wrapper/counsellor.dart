    ...
    return Scaffold(
      body: Column(children: [
        Container(
            ...
            child: const Text("Counselors",
                style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold))),
        Container(
            padding: const EdgeInsets.only(left: 28, top: 2, right: 15),
            alignment: Alignment.topLeft,
            child: const Text(
                "Select who your counselor is in order to get important anouncements and updates",
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          var counsellorStd =
                              snapshot.data.docs[index]['counsellor_std'];
                          var counsellorName =
                                ...
                                onTap: () {
                                  setState(() {
                                    ...
                                    DatabaseService(user: user)
                                        .addCounsellor(counsellorName);
                                    DatabaseService(user: user)
                                        .updateCounsellorMemberList(
                                            counsellorName);
                                  });
                                },
                              ),
